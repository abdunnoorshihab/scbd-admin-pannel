    ...
    <div class="content-wrapper ">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="text-dark mb-4">User Information</h1>
              </div>
                <div class="card-body m-5">
                  <form action="#" method="POST">
                      ...
                      <!-- Designation Section -->
                      <div class="mb-4">
                          <h2 class="h5 mb-3">Professional Information</h2>
                          <div class="row g-3">
                              <div class="col-md-4">
                              ...
                              <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control" id="organization" name="org">
                              </div>
                          </div>
                      </div>
                      ...
                      <!-- Address Section -->
                      <div class="mb-4">
                          <h2 class="h5 mb-3">Address</h2>
                          <div class="row g-3">
                              <div class="col-md-6">
                                  <label for="street1" class="form-label">Street 1</label>
                                  <input type="text" class="form-control" id="street1" name="st_1">
                              </div>
                              <div class="col-md-6">
                                  <label for="street2" class="form-label">Street 2</label>
                                  <input type="text" class="form-control" id="street2" name="st_2">
                              </div>
                              <div class="col-md-6">
                      ...
                      <div class="mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="radio-active">Active</label>
                          </div>
                          <div class="form-check form-check-inline">
